...
def plot_spectras_best_fit_scatter(
  ...
  """
  Plots and saves the best fit line for the given spectras.
...
def plot_spectras_best_fit_hex(
  ...
  """
  Plots and saves the best fit line for the given spectras using hexbin plot.
...
def main():
  ...
  # Loop over each mass resolution
  for MASS_RESOLUTION in MASS_RESOLUTIONS:
    # Get binning object
    ...
    PLOT_PATH = CWD / "esi" / f"bin_width_{MASS_RESOLUTION / 2}"
    # Create dirs
    ...
    plot_spectras_best_fit_scatter(
        processed_spectras, PLOT_PATH, file_plot_name
    )
